...
<html>
<head>
	<title>Outreach - Emmanuel Lutheran Church Eastmont</title>
	<meta charset="utf-8" />
	...
	<div id="wrapper">
		<div class="content">
			<div class="sectionTitleContainer">
				<p class="sectionTitle">Outreach</p>
				<?php
					//Show addBar if signed in as admin
					if (isset($_SESSION["username"])) {
						if ($_SESSION["admin"] == 1 || $_SESSION["admin"] == 2) {
							echo "<div class='editBar addBar'>";
							echo "    <a class='barOption' href='createpost.php?loc=outreach'>[add new post]</a>";
							echo "</div>";
						}
					}
				?>
			...
			<div class="container">
				...
				//Get all posts
				$query = "SELECT * FROM postsoutreach ORDER BY orderid";
