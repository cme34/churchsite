...
<html>
<head>
	<title>Church Year - Emmanuel Lutheran Church Eastmont</title>
	<meta charset="utf-8" />
	...
	<div id="wrapper">
		<div class="content">
			<div class="sectionTitleContainer">
				<p class="sectionTitle">Church Year</p>
				<?php
			...
			<div class="container">
				...
				//Get all posts
				$query = "SELECT * FROM postschurchyear ORDER BY orderid";
